...
const body = {
  description: 'Karpathy-style autoresearch for Base DEX. 222+ LLM-driven strategy mutations via Bankr LLM Gateway, backtested on 4 real Base pairs (Uniswap V3 + Aerodrome). Best score: 8.176 Sharpe (exp199). Now live as an x402 micropayment service — 0.10 USDC/signal, 0.50 USDC/validation, 2.00 USDC/discovery. First real x402 payment settled on Base (TX 0xa30089…, 0.10 USDC via DARKSOL Facilitator, EIP-3009). Revenue self-funds Bankr LLM credits. 51 tests. 49+ live Base trades.',
  submissionMetadata: {
